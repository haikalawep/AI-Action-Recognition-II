...
class MultiPersonVideoClassifier:
    ...
    def load_model(self):
        ...
        model.load_state_dict(torch.load("C:/Users/nyok/Downloads/VideoTest/best_x3d_model(newupdate).pth", map_location=map_location))
...
if __name__ == "__main__":
    video_path = "C:/Users/nyok/Downloads/VideoTest/manyWalk(1).mp4"
    root = tk.Tk()
